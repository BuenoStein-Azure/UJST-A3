...
public class CarrinhoService {
    ...
    public void adicionarAoCarrinho( ProdutoModel produto, RestaurantModel restaurant, int quantidade){ {
        ...
        if (user == null) {
            System.out.println( BRANCO + "\n    Nenhum usuário logado." + RESET + " Por favor, faça login para adicionar produtos ao carrinho.");
            return;
        }
        ...
        System.out.printf(VERDE_ESCURO + "%n    ✔ %dx %s adicionado(s) ao carrinho! (R$ %.2f cada)%n"+ RESET, 
...
// ver dps
  ...
  public void finalizarCompra(){
        ...
        System.out.println(VERDE_ESCURO + "──────────────────────────────────────────" + RESET);
        System.out.print("\n    Forma de pagamento:\n"
                + VERDE_ESCURO + "    1 -"+ RESET+ " Cartão de Débito\n"
                + VERDE_ESCURO + "    2 -"+ RESET+ " Cartão de Crédito\n"
                + VERDE_ESCURO + "    3 -"+ RESET+ " Pix\n"
                + VERDE_ESCURO + "    4 -"+ RESET+ " VR / VA\n"
                + "    Escolha: ");
        ...
        if (user.getMetodoPagamento() == null) {
            ...
            if (sc.nextInt() == 1) {
                ...
                System.out.println(VERMELHO + "\n    Pagamento cancelado." + RESET);
                 System.out.println("\n    Deseja escolher outra forma de pagamento? (1 - Sim / 2 - Não): ");
